...
//    cout<<"max bin: "<<mu<<"peak height: "<<hcut<<endl;
    ...
    t->Draw("chans>>h1(250,100,350)","weight");
    ...
    t->Draw("chans>>h0(250,100,350)","weight");
...
//    f->SetParNames("C","#alpha","#mu","#sigma","#beta","#lambda");
    ...
    c1->Divide(2,2);
    c1->cd(1);
    t->Draw("chans>>hraw(250,100,350)","weight");
    ...
    c1->cd(2);
    t->Draw("chans>>hraw2(250,100,350)","weight");
...
//    file_tmp = new TFile("tmp.root","read");
    ...
    tnew->Draw("energy>>hcal(250,25,125)","w");
...
//    f->SetParameters(C0, mean0*Efactor, sigma0*Efactor, C, mean*Efactor, sigma*Efactor);
    ...
    c1->cd(4);
    tnew->Draw("energy>>hcal2(250,25,125)","w");
